...
Relaxed \gls{dsc} of bulk material taken at different heating rates was used to establish the fragility of the \MgZnCa system.
$\beta^{-1} = 1.338E - 16e^{5274 (\frac{1}{T-T_{0}})}$ with Adj. $R^{2}=0.972$
