...
\begin{table}[h]
	...
	\begin{tabular}{ c c c }
		...
		\midrule
		Mg & $64.85 \pm 3.18$ & $63.20 \pm 3.28$ \\
		Zn & $29.55 \pm 0.82$ & $30.95 \pm 0.96$ \\
		Ca & $~~ 5.60 \pm 0.17$ & $~~ 5.85 \pm 0.19$ \\ 
		\bottomrule
	\end{tabular}
...
It was also observed that there was a some minor peak shifting between the Mg, \MgZn, and \CaMgZnFive~ phases in the dynamic bulk and film \acrshort{xrd}. The largest shifts were seen in the \CaMgZnFive~ 34.6\degree~ peak and \MgZn~ 39.1\degree~ peak of 1.4\% and 1.0\% respectively. These shifts are tabulated in Table \ref{tab:Dynamic_XRD_PeakShift}.
