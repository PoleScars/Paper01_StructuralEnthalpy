...
\begin{figure}[b]
	...
	\caption[Table of contents Capition]{\acrshort{xrd} pattern for bulk \MgZnCa~ heated treated to several temperatures for crystallization peak identified from \acrshort{dsc}.}
...
\begin{figure}[b]
	...
	\caption[Table of contents Capition]{\acrshort{xrd} pattern for film \MgZnCa~ heated treated to several temperatures for crystallization peak identified from \acrshort{dsc}. Note the Al substrate peaks have been faceted as to not dwarf all other peaks.}
