...
Alloy composition and homogeneity were confirmed by \acrshort{sem}-\acrshort{eds} (S3400, Hitachi, ?Japan?). Hyper-maps were collected with an accelerating voltage of $15-20kV$, a probe current of $50 \mu A$, counts of 5000 kps or better, dead time less than 20 \%, and working distance was 10mm.
...
\begin{figure}[b]
	\centering
	\includegraphics[width=0.85\textwidth]{XRD_Normalised_Dynamic_BulkFilm_Facet.png}
